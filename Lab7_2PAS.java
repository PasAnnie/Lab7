...
import java.util.Scanner;
    ...
    public class Lab7_2PAS{
        public static void main(String[] args) throws IOException, ClassNotFoundException{
            Scanner sc=new Scanner(System.in);
            File mountainData=new File("C:\\Mountain\\mount.txt");
            File answer=new File("C:\\Mountain\\mmm.txt");
            ...
            for (int i = 0; i < count; i++) {
                moun = new Mountain();
                System.out.println("Место расположения ");
                moun.place = sc.nextLine();
                System.out.println("Название горы ");
                moun.Name = sc.nextLine();
                System.out.println("Высота горы  ");
